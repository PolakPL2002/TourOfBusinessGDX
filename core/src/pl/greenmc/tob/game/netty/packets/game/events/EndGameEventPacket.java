...
public class EndGameEventPacket extends Packet {
    /**
     ...
     */
    public EndGameEventPacket(JsonObject objectToDecode) throws InvalidPacketException {
