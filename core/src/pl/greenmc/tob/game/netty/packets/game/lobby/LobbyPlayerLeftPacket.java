...
public class LobbyPlayerLeftPacket extends Packet {
    /**
     * Packet data type identifier
     */
    public static String TYPE = "GAME_LOBBY_PLAYER_LEFT";
    private final int playerID;

    public LobbyPlayerLeftPacket(int playerID) {
     ...
     */
    public LobbyPlayerLeftPacket(JsonObject objectToDecode) throws InvalidPacketException {
