...
public class TradePacket extends Packet {
     ...
     */
    public static final String TYPE = "GAME_TRADE";
    @NotNull
     ...
     * Default constructor
     */
    public TradePacket(int playerID, @NotNull TradeDialog.Property[] player1Offer, @NotNull TradeDialog.Property[] player2Offer) {
     ...
     */
    public TradePacket(JsonObject objectToDecode) throws InvalidPacketException {
    ...
    @NotNull
    public static JsonObject generateResponse(boolean valid) {
    ...
    public static boolean parseResponse(@NotNull JsonObject response) throws InvalidPacketException {
        //Decode values
        JsonElement valid = response.get("valid");
        if (valid == null || !valid.isJsonPrimitive())
            throw new InvalidPacketException();
