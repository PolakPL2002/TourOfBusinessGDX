...
public class Version implements Comparable<Version> {
    ...
    public Version(int major, int minor, long build) {
        this.major = major;
        this.minor = minor;
        this.build = build;
    }
    ...
    @NotNull
    @Contract("_ -> new")
    public static Version fromString(@NotNull String s) throws NumberFormatException {
        ...
        int minor = 0;
        long build = 0;
        if (split.length > 1) minor = Integer.parseInt(split[1]);
        if (split.length > 1) build = Long.parseLong(split[2]);
