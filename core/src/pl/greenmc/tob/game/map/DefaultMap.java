...
public class DefaultMap extends Map {
    ...
    private void setupTiles(Texture o, Texture o2, Texture o3, Texture o4, Texture o5, Texture o6, Texture o7, Texture o8,
        ...
        setTiles(new Tile[]{
                ...
                new Tile(o2, new Tile.CityTileData("Grenada", group1, 1000, 1000, 1000)),
                new Tile(o3, new Tile.CommunityChestTileData()),
                new Tile(o4, new Tile.CityTileData("Madryt", group1, 1000, 1000, 1000)),
                new Tile(o5, new Tile.IncomeTaxTileData(300000)),
                new Tile(o6, new Tile.StationTileData("Stacja na Bali", stationGroup, 1000, 1000)),
                new Tile(o7, new Tile.CityTileData("Hongkong", group2, 1000, 1000, 1000)),
                new Tile(o8, new Tile.ChanceTileData()),
                new Tile(o9, new Tile.CityTileData("Pekin", group2, 1000, 1000, 1000)),
                new Tile(o10, new Tile.CityTileData("Szanghaj", group2, 1000, 1000, 1000)),
                new Tile(o11, new Tile.JailTileData(jailGroup, 1000, 3)),
                new Tile(o12, new Tile.CityTileData("Wenecja", group3, 1000, 1000, 1000)),
                new Tile(o13, new Tile.UtilityTileData("Elektrownia", utilityGroup, 1000, 10)),
                new Tile(o14, new Tile.CityTileData("Mediolan", group3, 1000, 1000, 1000)),
                new Tile(o15, new Tile.CityTileData("Rzym", group3, 1000, 1000, 1000)),
                new Tile(o16, new Tile.StationTileData("Stacja na Cyprze", stationGroup, 1000, 1000)),
                new Tile(o17, new Tile.CityTileData("Hamburg", group4, 1000, 1000, 1000)),
                new Tile(o3, new Tile.CommunityChestTileData()),
                new Tile(o18, new Tile.CityTileData("Monachium", group4, 1000, 1000, 1000)),
                new Tile(o19, new Tile.CityTileData("Berlin", group4, 1000, 1000, 1000)),
                new Tile(o20, new Tile.PlaceholderTileData(1000)),
                new Tile(o21, new Tile.CityTileData("Londyn", group5, 1000, 1000, 1000)),
                new Tile(o8, new Tile.ChanceTileData()),
                new Tile(o22, new Tile.CityTileData("Manchester", group5, 1000, 1000, 1000)),
                new Tile(o23, new Tile.CityTileData("Sydney", group5, 1000, 1000, 1000)),
                new Tile(o24, new Tile.StationTileData("Stacja w Dubaju", stationGroup, 1000, 1000)),
                new Tile(o25, new Tile.CityTileData("Chicago", group6, 1000, 1000, 1000)),
                new Tile(o26, new Tile.CityTileData("Las Vegas", group6, 1000, 1000, 1000)),
                new Tile(o27, new Tile.UtilityTileData("Wodociągi", utilityGroup, 1000, 10)),
                new Tile(o28, new Tile.CityTileData("Nowy Jork", group6, 1000, 1000, 1000)),
                new Tile(o29, new Tile.GoToJailTileData(jailGroup)),
                new Tile(o30, new Tile.CityTileData("Lyon", group7, 1000, 1000, 1000)),
                new Tile(o31, new Tile.CityTileData("Genewa", group7, 1000, 1000, 1000)),
                new Tile(o3, new Tile.CommunityChestTileData()),
                new Tile(o32, new Tile.CityTileData("Paryż", group7, 1000, 1000, 1000)),
                new Tile(o33, new Tile.StationTileData("Stacja w Nicei", stationGroup, 1000, 1000)),
                new Tile(o8, new Tile.ChanceTileData()),
                new Tile(o34, new Tile.CityTileData("Kraków", group8, 1000, 1000, 1000)),
                new Tile(o35, new Tile.LuxuryTaxTileData(150000)),
                new Tile(o36, new Tile.CityTileData("Warszawa", group8, 1000, 1000, 1000))
        });
    }
